...
The second outcome is the **fitted model** (@equ:lm1 and @equ:lm-error) which we will use to generate predictions about how the differential response of natives and invasives to nitrogen and microbes will affect the strength of competition between natives and invasives.
...
source("helper-simulation-experiment.R")
```
