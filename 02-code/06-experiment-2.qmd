...
# export the dat_ex2_plot object for use in the simulation experiment
plot_dat_name <- paste0(i_species_sel, paste0("-exclude_high_N-", exclude_high_N),
                        "-exp2-plot-data.rds")
saveRDS(object = dat_ex2_plot,
        file = file.path("outputs", plot_dat_name))
